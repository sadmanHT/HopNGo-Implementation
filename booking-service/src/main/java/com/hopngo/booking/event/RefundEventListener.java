...
/**
 * Event records for refund SAGA communication.
 * These should match the events published by market-service.
 */
record RefundRequestedEvent(
    UUID refundId,
    UUID bookingId,
    UUID paymentId,
