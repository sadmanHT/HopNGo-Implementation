...
const navigation: NavItem[] = [
  ...
  { name: 'Heatmap', href: '/map', icon: MapPin },
  { name: 'Marketplace', href: '/marketplace', icon: ShoppingBag },
  { name: 'Messages', href: '/messages', icon: MessageCircle },
  { name: 'Profile', href: '/profile', icon: User },
  { name: 'Provider Verification', href: '/provider/verification', icon: CheckCircle },
    ...
    <div className={cn(
      ...
      <div className="border-t border-gray-200 p-4">
        ...
        <div className="space-y-1">
          <Link
            href="/settings"
            className="flex items-center px-2 py-1 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded"
            onClick={() => mobile && setSidebarOpen(false)}
          >
          ...
          <button
            ...
            className="flex items-center w-full px-2 py-1 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded"
          >
